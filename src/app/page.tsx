    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-20">
        ...
        <p className="text-xl md:text-2xl text-gray-300 text-center max-w-xl mb-3 font-light">
          ...
          <span className="text-rose-400 font-medium"> 100-day average impressions </span>
        </p>
        ...
        <div className="w-full max-w-3xl">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">
                We estimate your 100-day avg impressions/day
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-rose-500/10 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="px-4 py-16 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-10 text-sm">
            Your estimated 100d avg impressions/day determines your category
          </p>
